...
import 'package:management/Screens/ParentScreens/navi_parent.dart';
import 'package:management/Screens/ParentScreens/parent_dashboard.dart';

class Parent_LogIn_Screen extends StatefulWidget {
  const Parent_LogIn_Screen({super.key});
